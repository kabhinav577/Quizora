  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-12 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4">
              {exams.map((exam) => (
                <Link key={exam.id} href={`/tests?examId=${exam.id}`} className="group">
                  <div className="p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 hover:border-primary/50 hover:shadow-md transition-all">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-bold text-base text-slate-900 dark:text-slate-100 group-hover:text-primary transition-colors">
                        {exam.name}
                      </span>
              ...
              return (
                ...
                >
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-base font-bold text-slate-900 dark:text-slate-100 group-hover:text-primary transition-colors">
                      {test.title}
                    </CardTitle>
